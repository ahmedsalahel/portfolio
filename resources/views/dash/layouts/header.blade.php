...
<head>
	...
	<!-- Toastr CSS -->
    <link href="{{ asset('dash_assets/vendors/jquery-toast-plugin/dist/jquery.toast.min.css') }}
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="dropdown-icon zmdi zmdi-power"></i><span>
                ...
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'skills' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.skills.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'settings' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.settings.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                                <span class="nav-link-text">Settings</span>
                                <span class="badge badge-primary badge-pill"></span>
                            </a>
                        <li class="nav-item {{ request()->segment(2) == 'projects' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.projects.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'professionals' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.Professionals.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'messages' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.messages.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'educations' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.educations.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
                                <span class="nav-link-text">educations</span>
                                <span class="badge badge-primary badge-pill"></span>
                            </a>

                        </li>
                        <li class="nav-item {{ request()->segment(2) == 'experiences' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.experiences.index') }}"  >
                                <span class="feather-icon"><i data-feather="package"></i></span>
