...
<div class="col-xl-12">
    <section class="hk-sec-wrapper">
        ...
        <div class="row">
            <div class="col-sm">
                <form action="{{ route('dashboard.skills.update' , $skill->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="name" value="{{ $skill->name }}" class="form-control" id="username" placeholder="name of skill" type="text">
                        </div>
                        @error('name')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
