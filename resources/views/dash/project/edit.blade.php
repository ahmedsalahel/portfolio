            ...
            <div class="col-sm">
                <form action="{{ route('dashboard.projects.update' , $project->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        <img src="{{ $project->image }}" width="150" height="150" alt="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="name" value="{{ $project->name }}" class="form-control" id="username" placeholder="name of skill" type="text">
                        </div>
                        @error('name')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="link" name="link" value="{{ $project->link }}" class="form-control" aria-label="Default"
                    ...
                    <div>
                        ...
                        <textarea value="{{ $project->description }}" class="form-control mt-15" id="description"  rows="3" name="description" placeholder="Textarea"></textarea>
                    </div>
                    @error('description')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
