        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">Ahmed Salah</span></a>
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Backend &middot; Php &middot; Laravel &middot; Developer</div></div>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img"  src="{{ $image->image }}" alt="{{ $image->name }}" />
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-light mb-4">{{ $skill->name }}</p>
                                <p class="text-muted">{{ $skill->description }}</p>
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="{{ $skill->linkedin }}"><i class="bi bi-linkedin"></i></a>
                                    <a class="text-gradient" href="{{ $skill->github }}"><i class="bi bi-github"></i></a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
