        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="{{ route('home') }}"><span class="fw-bolder text-primary">Portfolio</span></a>
                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <!-- to get an API token!-->
                                <form action="{{ route('contacts_us') }}" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                    @csrf
                                    <!-- Name input-->
                                    ...
                                    <!-- Submit Button-->
                                    <button class="btn btn-primary custom-btn" type="submit">subimt</button>
                                </form>
                            </div>
                        </div>
                    </div>
